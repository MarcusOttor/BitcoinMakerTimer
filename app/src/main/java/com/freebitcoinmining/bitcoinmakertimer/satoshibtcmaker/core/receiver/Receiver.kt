package com.freebitcoinmining.bitcoinmakertimer.satoshibtcmaker.core.receiver
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (prefs.get(PreferencesManager.FIRST_LAUNCH, false)) {
            ...
            nm.notify(0, NotificationCompat.Builder(context).setContentTitle(context.getString(R.string.app_name))
                    .setContentText("Yor reward is ready! Claim bonus Satoshi!").setSmallIcon(R.drawable.coin)
